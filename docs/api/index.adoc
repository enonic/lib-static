...
- The third, link:getstaticpath#api-getstaticpath[getStaticPath], is a helper function that generates a URL pointing to a static file.

👉 link:get#example-get[Similarities and differences]
